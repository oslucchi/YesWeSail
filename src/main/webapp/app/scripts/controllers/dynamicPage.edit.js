 ...
 */
angular.module('yeswesailApp').controller('DynamicPageEditCtrl', function ($scope, toastr, $rootScope, AUTH_EVENTS, AuthService, ngDialog, $http, $window, URLs, $stateParams, moment, $state) {
    $scope.dynamicPage = {
        createdOn: ''
        , uRLReference: ''
        , innerHTML: ''
